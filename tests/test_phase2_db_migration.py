...
class TestPhase2DbMigrationGuardrails(unittest.TestCase):
    ...
    def test_cmm_and_bom_manager_no_longer_use_direct_sqlite_connect(self):
        ...
        self.assertIn('from metroliza.reports.report_repository import ReportRepository', cmm_parser)
        self.assertIn('from metroliza.reports.report_schema import ensure_report_schema', cmm_parser)
        self.assertIn('from metroliza.reports.db import (', bom_manager)
