...
class TestExportBackendSmoke(unittest.TestCase):
    ...
    def test_summary_sheet_fill_histogram_uses_native_path_for_extended_dashboard_when_native_backend_is_selected(self):
        import pandas as pd
        import modules.export_data_thread as export_thread_module
        from modules.contracts import AppPaths, ExportOptions, ExportRequest
        ...
        assert isinstance(thread._chart_renderer.last_payload, dict)
        assert isinstance(thread._chart_renderer.last_payload.get('resolved_render_spec'), dict)
