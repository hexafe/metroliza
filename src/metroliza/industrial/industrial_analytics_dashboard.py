    ...
    *,
    ...
    if interactivity["mode"] == "static" and plotly_spec_count > 0:
        dashboard_manifest = _copy_manifest_without_plotly_specs(
            manifest,
            note_message=(
                "Interactive chart omitted because static dashboard mode was selected; "
                "snapshot and summary content remain available."
            ),
        )
    else:
...
def _copy_manifest_with_plotly_budget(
    ...
    *,
    ...
    if omitted_indexes:
        note = (
            "Interactive chart omitted because this chart's Plotly payload exceeded the "
            "saved-dashboard budget; snapshot and summary content remain available."
        )
    ...
    *,
    ...
    if not include_plotly_specs:
        return {
            ...
            "notes": [
                "Interactive chart omitted because static dashboard mode was selected; "
                "summary content remains available."
            ],
        }
    resolved_layout = {
...
def _render_dashboard_html(
    ...
    *,
    ...
    if plotly_runtime_status == "snapshot_only":
        ...
        plotly_budget_notice = (
            '<p class="runtime-note">Some interactive charts were omitted in this dashboard because '
            'their Plotly payload exceeded the saved-dashboard budget. Snapshot and summary content '
            'remain available.</p>'
        )
