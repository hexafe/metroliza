...
from metroliza.reports.db import execute_select_with_columns, read_sql_dataframe
...
def _read_sql_query(db_file, query, *, params=(), connection: sqlite3.Connection | None = None):
    return read_sql_dataframe(db_file, query, params=params, connection=connection)
