"""Unified backend diagnostics for export and native-fallback status surfaces."""
...
from metroliza.native_bridges import comparison_stats_native
from metroliza.native_bridges import distribution_fit_candidate_native
from metroliza.native_bridges import distribution_fit_native
from metroliza.native_bridges import group_stats_native
...
def _resolve_distribution_fit_entry() -> dict[str, Any]:
    ...
    effective = distribution_fit_native.resolve_distribution_fit_backend()
    return _build_backend_entry(available=available, selected_mode=selected_mode, effective_backend=effective)
