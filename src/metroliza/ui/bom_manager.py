...
DEPRECATION_NOTICE = (
    "BOMManager is deprecated for the 2026.06 RC2 compatibility window and is no longer "
    "a supported primary workflow; migrate callers before the next release line."
)
_DEPRECATION_WARNING_EMITTED = False


def _warn_deprecated_bom_manager() -> None:
