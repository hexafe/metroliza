"""Deterministic post-processing rules for report-header OCR text.

These corrections normalize report metadata and are therefore owned by
:mod:`metroliza.reports`.  The former ``metroliza.parsing.header_ocr_corrections`` path remains a
module-identity compatibility alias.
"""
