    ...
    def init_widgets(self):
        try:
            ...
            self.html_dashboard_note_label = QLabel(
                "Creates a local `*_dashboard.html` file plus an asset folder with offline Plotly charts and workbook-matching PNG snapshots."
            )
            ...
            self.html_dashboard_label.setToolTip(
                ...
                "Useful for browser-based review alongside the workbook, with a local Plotly runtime copied into the asset folder."
            )
