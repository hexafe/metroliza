...
COLOR_TEXT_MUTED = "#AEB7C4"
COLOR_TEXT_DISABLED = "#8A93A3"
COLOR_TEXT_HELPER = COLOR_TEXT_MUTED
COLOR_BORDER_DEFAULT = "#5B667A"
...
def button_style(variant='secondary'):
    ...
    return (
        ...
        f" border: {BUTTON_INTERACTION['default_border_width']}px solid {COLOR_BORDER_STRONG};"
