...
- Histogram, distribution, IQR, and trend now use planner-driven native fast-path payloads in the export runtime whenever the chart kind is allowlisted and the native backend is available.
