...
- [ ] Extract additional `ExportDataThread` writer helpers:
  - [ ] summary-sheet row layout planner
  - [ ] chart insertion/format policy helper
  - [ ] per-header worksheet write bundle helper
- [ ] Add regression tests for extracted writer helpers to preserve worksheet range and chart-series parity.
