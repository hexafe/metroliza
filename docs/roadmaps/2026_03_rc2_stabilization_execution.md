...
Execute a **Phase A parity evidence pass**: run and record release-check export parity evidence for merged EX-001/EX-002/EX-003/EX-008 seams, then continue with the next smallest `export_data_thread` extraction slice.
