...
| --- | --- | --- | --- | --- |
| Final RC4 commit and fresh CI baseline | `informational` | Release owner | 2026.05 RC4 | PR #895 CI run `26326503387` passed for the latest code commit before this documentation refresh, `d0ce9f38061f9af747ee234f27cc46c534355aff`; refresh this row after any newer code change. |
