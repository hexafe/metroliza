...
| Current directory-reorganization audit | Reorg complete / release blocked | The layout migration is complete on `codex/directory-reorg-plan`; parser profile self-service follow-up CI passed for published SHA `8d7717e4755d8bdba5593a6e05342f6f4a90143b` in run `26719879455`. Final Go still requires manual release evidence. | [`release_candidate_checklist.md`](./release_candidate_checklist.md), [`implementation_item_triage.md`](./implementation_item_triage.md) |
