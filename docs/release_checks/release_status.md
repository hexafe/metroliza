...
| 2026.06 RC1 realtime industrial tester build | Local and pushed CI passed | Build `260614` adds the realtime industrial monitoring foundation, deterministic anomaly detectors, replay validation, bounded polling service tests, realtime dashboard docs, optional advanced anomaly helpers, CMM probe hardening, parser handoff coverage, and industrial diagnostics redaction. Local evidence is recorded in [`realtime_industrial_rollout_checklist.md`](./realtime_industrial_rollout_checklist.md). Default pushed CI passed in run [`27506446912`](https://github.com/hexafe/metroliza/actions/runs/27506446912) for commit `307acd16031c5622093ba52a9a64d2b2146d7f02`. This build is suitable for controlled tester feedback. Promotion remains blocked on manual packaging, Windows clean-machine launch, Google conversion smoke, third-party notice evidence, and security-owner triage/waiver for any remaining report-only findings. | [`realtime_industrial_rollout_checklist.md`](./realtime_industrial_rollout_checklist.md), [`implementation_item_triage.md`](./implementation_item_triage.md) |
