...
| Current directory-reorganization audit | Reorg complete / release blocked | The layout migration is complete on `codex/directory-reorg-plan`; local QA/release gates were refreshed for the chart reference-label dedupe and `260601` build-date update. Final Go still requires green CI for the pushed SHA plus manual release evidence. | [`release_candidate_checklist.md`](./release_candidate_checklist.md), [`implementation_item_triage.md`](./implementation_item_triage.md) |
