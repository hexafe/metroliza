...
| 2026.06 RC1 realtime industrial tester build | Local gate passed / pushed CI pending | Build `260614` adds the realtime industrial monitoring foundation, deterministic anomaly detectors, replay validation, bounded polling service tests, realtime dashboard docs, optional advanced anomaly helpers, CMM probe hardening, parser handoff coverage, and industrial diagnostics redaction. Local evidence is recorded in [`realtime_industrial_rollout_checklist.md`](./realtime_industrial_rollout_checklist.md). This build is suitable for controlled tester feedback after final pushed CI passes. Promotion remains blocked on manual packaging, Windows clean-machine launch, Google conversion smoke, third-party notice evidence, and security-owner triage/waiver for any remaining report-only findings. | [`realtime_industrial_rollout_checklist.md`](./realtime_industrial_rollout_checklist.md), [`implementation_item_triage.md`](./implementation_item_triage.md) |
...
- Final pushed GitHub Actions evidence for build `260614` is pending until this
