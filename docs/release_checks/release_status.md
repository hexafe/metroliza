...
| Current directory-reorganization audit | Reorg complete / release blocked | The layout migration is complete on `codex/directory-reorg-plan`; required CI passed for published SHA `9d18b61` in run `26687615343`. Any later follow-up commit still requires fresh green CI, and final Go requires manual release evidence. | [`release_candidate_checklist.md`](./release_candidate_checklist.md), [`implementation_item_triage.md`](./implementation_item_triage.md) |
