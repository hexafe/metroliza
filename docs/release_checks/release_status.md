...
| 2026.06 RC2 SQLite-first CSV Summary/export build | Build `260626` magic-filter syntax gates passed; SQLite realtime event-stream local gates passed and push CI is pending | Build `260617` adds indexed Industrial Data cache handoff, faster CSV Summary filter/group previews, raw cached workbook export, additional export-filter enforcement, same-session cache refresh fixes, Oznak fallback partial-progress diagnostics, realtime polling cost reductions, and an Industrial Sync layout fix found by the CI-shaped UI shard. The June 19 closeout adds SQLite transfer follow-up gates plus UI overlap/layout hardening for PyQt dialogs, generated dashboards, native chart geometry, and workbook image slots. Build `260623` added the CMM parser resolver hotfix and pandas-free runtime helper coverage, shared SQLite row/query contracts, direct grouped SQLite summaries, and updated before/after benchmark evidence for CSV Summary and export paths. Build `260626` verifies the shared magic-filter expression parser across CSV/Excel pandas filtering, SQLite pushdown, the Magic filter dialog, and Export's CMM SQL filter path, including case-insensitive field/operator parsing, `IN`/`NOT IN`, and repeated-field shorthand ranges. The 2026-07-04 event-stream closeout adds a SQLite-backed local event log, per-consumer offsets, detector-consumer retry safety, stream event idempotency by source/stream, and UI surfacing for detector-consumer failures while keeping dashboard reads on persisted tables. Local evidence is recorded in this status page plus [`realtime_industrial_performance_check_2026-06-17.md`](./realtime_industrial_performance_check_2026-06-17.md), [`ui_overlap_layout_audit_2026-06-19.md`](./ui_overlap_layout_audit_2026-06-19.md), [`rc2_pandas_free_sqlite_performance_2026-06-23.md`](./rc2_pandas_free_sqlite_performance_2026-06-23.md), and [`../roadmaps/sqlite_realtime_event_stream.md`](../roadmaps/sqlite_realtime_event_stream.md). Build `260626` pushed CI passed in run [`28220479719`](https://github.com/hexafe/metroliza/actions/runs/28220479719) for commit `a7e1ab0b2bf7612e2d44a907b88d00db87ae3e02`; earlier integrated RC2 pushed CI passed in run [`28035951993`](https://github.com/hexafe/metroliza/actions/runs/28035951993) for commit `4a9f159a8c6a77a824a7170b61f0877f08978984`. Promotion remains blocked on manual packaging, Windows clean-machine launch, Google conversion smoke, third-party notice evidence, and security-owner triage/waiver for any remaining report-only findings. | [`realtime_industrial_rollout_checklist.md`](./realtime_industrial_rollout_checklist.md), [`realtime_monitor_ui_ux_audit_2026-06-15.md`](./realtime_monitor_ui_ux_audit_2026-06-15.md), [`realtime_industrial_optimization_check_2026-06-16.md`](./realtime_industrial_optimization_check_2026-06-16.md), [`realtime_industrial_performance_check_2026-06-17.md`](./realtime_industrial_performance_check_2026-06-17.md), [`ui_overlap_layout_audit_2026-06-19.md`](./ui_overlap_layout_audit_2026-06-19.md), [`rc2_pandas_free_sqlite_performance_2026-06-23.md`](./rc2_pandas_free_sqlite_performance_2026-06-23.md), [`../roadmaps/sqlite_realtime_event_stream.md`](../roadmaps/sqlite_realtime_event_stream.md), [`implementation_item_triage.md`](./implementation_item_triage.md) |
...
- The 2026-07-04 SQLite realtime event-stream closeout adds
  ...
  (`2253 passed, 324 skipped, 114 warnings, 83 subtests passed`). Pushed CI for
  this closeout is pending on the current branch commit.
