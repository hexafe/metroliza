...
| Current directory-reorganization audit | Reorg complete / release blocked | The layout migration is complete on `codex/directory-reorg-plan`; local QA/release gates were refreshed for dashboard UX/copy unification, static POPULATION layer support, Export/CSV Summary grouping cleanup, the raised 80% combined coverage gate, and the `260602` build identity. Previous validation SHA `05b5049558509060df43778d7b39424726e56ff1` passed default GitHub Actions CI in run [`26875151720`](https://github.com/hexafe/metroliza/actions/runs/26875151720). The final docs/freeze merge commit still needs pushed rc2 CI evidence recorded after merge. Final Go remains blocked on manual release evidence and any explicit must-fix triage items. | [`release_candidate_checklist.md`](./release_candidate_checklist.md), [`implementation_item_triage.md`](./implementation_item_triage.md) |
...
## Pre-merge validation CI evidence
...
- This evidence predates the end-user training and feature-freeze documentation update; record the final pushed rc2 CI run after merge.
