...
Archived one-off documents moved during documentation policy cleanup.
All items below are historical/completed and should not be used as active execution guidance.

- `GOOGLE_SHEETS_MIGRATION_PLAN.md` — historical completed migration planning notes.
- `IMPLEMENTATION_PLAN.md` — historical completed implementation phase tracker.
- `TODO.md` — historical stale checklist superseded by current workflows.
- `repo_cleanup_and_docs_plan.md` — historical one-time repository cleanup planning notes.
- `README_legacy_full.md` — historical previous verbose root README content.
...
- `feature-nuitka-parser-audit/` — archived packaged-parser audit workspace after fail-closed packaging and CI smoke hardening landed.
- `feature-parser-plugin-factory/` — archived intermediate parser-plugin quickstart/status docs superseded by the active parser-plugin documentation set.
