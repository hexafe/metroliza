...
a = Analysis(
    ...
    pathex=[],
    binaries=windows_runtime_binaries + pymupdf_binaries + fitz_binaries + hexafe_groupstats_binaries,
    datas=html_dashboard_datas + pymupdf_datas + fitz_datas + hexafe_groupstats_datas,
    hiddenimports=[
