...
hexafe_plotstats_datas, hexafe_plotstats_binaries, hexafe_plotstats_hiddenimports = _collect_optional_runtime_assets('hexafe_plotstats')
...
hexafe_plotstats_metadata_datas = _collect_optional_distribution_metadata('hexafe-plotstats')
...
a = Analysis(
    ...
    pathex=[],
    binaries=windows_runtime_binaries + pymupdf_binaries + fitz_binaries + hexafe_groupstats_binaries + hexafe_plotstats_binaries + oznak_binaries + rapidocr_binaries + onnxruntime_binaries + openvino_binaries + cv2_binaries + numpy_binaries,
    datas=third_party_notice_datas + html_dashboard_datas + pymupdf_datas + fitz_datas + hexafe_groupstats_datas + hexafe_plotstats_datas + oznak_datas + rapidocr_datas + onnxruntime_datas + openvino_datas + cv2_datas + numpy_datas + rapidocr_metadata_datas + onnxruntime_metadata_datas + openvino_metadata_datas + opencv_python_metadata_datas + numpy_metadata_datas + hexafe_plotstats_metadata_datas + oznak_metadata_datas + ocr_model_datas,
    hiddenimports=[
